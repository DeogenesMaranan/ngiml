...
def build_default_components():
    ...
    default_aug = AugmentationConfig(
        ...
        enable_rescale=True,
        rescale_prob=0.35,
        rescale_factor_range=(0.6, 0.9),
        enable_compression=True,
        compression_prob=0.5,
        compression_quality_range=(35, 85),
    )
...
def build_training_config(
    ...
    return {
        ...
        "overfit_guard_min_epochs": 4,
        "overfit_guard_loss_gap": 0.08,
        "overfit_guard_min_val_increase": 0.01,
        "training_phase": "phase1",
        "auto_phase2_enabled": False,
        "auto_phase2_patience": 3,
